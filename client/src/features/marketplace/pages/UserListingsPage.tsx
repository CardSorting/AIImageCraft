...
import { ListingAnalyticsDashboard } from "../components/ListingAnalyticsDashboard";
import {
...
export function UserListingsPage() {
  ...
  const { data: analytics, isLoading: isAnalyticsLoading } = useQuery({
    queryKey: ["/api/marketplace/listings/analytics"],
    queryFn: () => marketplaceService.getListingAnalytics(),
  });
    ...
    <div className="container mx-auto py-8 space-y-6">
          ...
          <CardContent className="p-0 flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-2xl font-bold">
                {stats?.soldListings && stats?.totalListings
        ...
        <Card className="p-4">
          <CardContent className="p-0 flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-2xl font-bold">
                {stats?.totalValue && stats?.totalListings
      ...
      {selectedView === "analytics" ? (
        isAnalyticsLoading ? (
          ...
          <ListingAnalyticsDashboard analytics={analytics} />
        ) : (
